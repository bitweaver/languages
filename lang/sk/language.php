...
"A new article was submitted by {\$mail_user} to {\$mail_site} at {\$mail_date|bit_short_datetime}" => "Nový článok od {\$mail_user} bol odoslaný na {\$mail_site} v {\$mail_date|bit_short_datetime}",
...
"Banner raw data" => "Čisté dáa banneru",
...
"Cannot read file" => "Nie je možné číať súbor",
...
"Displays the data using a monospace font" => "Zobrazí dáa neproporčným písmom",
"Displays the data using the TikiWiki odd/even table style" => "Zobrazí dáa v TikiWiki tabulke zo striedavými podkladmi riadkov",
...
"New blog post: {\$mail_title} by {\$mail_user} at {\$mail_date|bit_short_datetime}" => "Nový záznam blogu: {\$mail_title} od {\$mail_user} dňa {\$mail_date|bit_short_datetime}",
...
"Read message" => "Číať správu",
"Read" => "Číať",
"Reading article from" => "Číať článok z",
"Reading note:" => "Číať poznámku:",
...
"The page {\$mail_page} was changed by {\$mail_user} at {\$mail_date|bit_short_datetime}" => "Stránka {\$mail_page} bola zmenená. Zmenu previedol(a) {\$mail_user} v {\$mail_date|bit_short_datetime}",
...
"You dont have permission to read the template" => "Nemáte dostatočné oprávnenia. Nemôžete načíať šablónu",
"You dont have permission to use this feature" => "Nemáte dostatočné oprávnenia.",
"You dont have permission to view other users data" => "Nemáte dostatočné oprávnenia. Nemôžete prezerať dáa ostatných užívateľov",
