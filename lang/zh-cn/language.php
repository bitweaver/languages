...
'A List of Spy Agency(s) (Groups) that will be allowed to see the Messages. Each Agency must be separated ' => '',
...
'be offline' => '正离线中',
'be online' => '正在在线',
'be redefined by using the the | character to separate the headers like this:' => '',
