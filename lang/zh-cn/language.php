...
'<a href="{$smarty.const.STATS_PKG_URL}users.php">Users</a>' => '',
...
'To install more packages, please run the <a href=\'{$smarty.const.INSTALL_PKG_URL}install.php?step=3\'>installer</a> to choose your desired packages.' => '',
'To Points' => '至分数',
...
'You will need to <a href="`$smarty.const.LANGUAGES_PKG_URL`edit_language.php">clear the System Cache</a> to see the changes.' => '',
