...
"The map {\$mail_page} was changed by {\$mail_user} at {\$mail_date|bit_short_datetime}" => "Мапа {\$mail_page} була змінена {\$mail_user} в {\$mail_date|bit_short_datetime}",
...
"MyTikiDoc" => "MyTikiDoc",
"my bitweaver.tpl" => "шаблон мого тікі",
...
"A new article was submitted by {\$mail_user} to {\$mail_site} at {\$mail_date|bit_short_datetime}" => "Нова стаття була надана {\$mail_user} до {\$mail_site} о {\$mail_date|bit_short_datetime}",
...
"New blog post: {\$mail_title} by {\$mail_user} at {\$mail_date|bit_short_datetime}" => "Нова публікація журналу: {\$mail_title} від {\$mail_user} о {\$mail_date|bit_short_datetime}",
...
"The page {\$mail_page} was changed by {\$mail_user} at {\$mail_date|bit_short_datetime}" => "Сторінка {\$mail_page} була змінена {\$mail_user} о {\$mail_date|bit_short_datetime}",
