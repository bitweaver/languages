...
'Add' => 'Legg il',
'Add a comment' => 'Lägg il kommentar',
...
'Add a File Gallery' => '',
'Add all users' => '',
'Add all your site users to this newsletter (broadcast)' => 'Lägg il alla sajtens användare il detta nyhetsbrev (sprid ut)',
'Add a new group' => 'Legg il en ny gruppe',
'Add a new site' => 'Add a new site',
'Add a new user' => 'Legg il en ny bruker',
'Add an operator to the system' => 'Add an operator to the system',
'Add a related category' => 'Add a related category',
'add article' => 'lägg il artikel',
'add a site' => 'add a site',
'Add a subscription newsletters' => 'Lägg il prenumeration på nyhetsbrev',
'Add a transition' => 'Add a transition',
'Add a translation' => 'legg il en oversettelse',
'Add Banned Word' => '',
'Add Calendar Item' => '',
'add comment' => 'legg il kommentar',
'add contacts' => 'Lägg il kontakt',
'Added' => 'Added',
'Added users' => 'Added users',
'add email' => 'add email',
'Add Featured Link' => 'Lägg il utvald link',
'Add Hotword' => 'Add Hotword',
'Add Image' => 'Legg il Bilde',
'add item' => '',
'Add messages from this email to the forum' => 'Add messages from this email to the forum',
'add new' => 'add new',
'Add new category' => '',
'Add New Group' => '',
'Add new mail account' => 'Lägg il entt nytt mailkonto',
'Add new rule' => '',
'Add notification' => 'Lägg il besked',
'Add objects to category' => 'Lägg il objekt il kategorin',
'Add or edit a category' => 'Lägg il eller redigera en kategori',
'Add or edit a chart' => 'Add or edit a chart',
'Add or Edit a Group' => 'Legg il eller Rediger Gruppe',
'Add or edit an activity' => 'Add or edit an activity',
'Add or edit a news server' => 'Add or edit a news server',
'Add or edit an item' => 'Legg il eller rediger en ting',
...
'Add or edit a URL' => 'Lägg il eller redigera en URL',
'Add or edit event' => 'Add or edit event',
'Add or edit folder' => 'Lägg il eller redigera mappen',
'add page' => 'legg il side',
'Add pages to current node' => '',
'Add property' => 'Add property',
'Address book' => 'Addres bok',
'add role' => 'add role',
'Add scaled images size X x Y' => 'Add scaled images size X x Y',
'Add the pages you want to print as one.' => 'Legg il de sidene du ønsker å skrive ut som en',
'Add This Image to These Galleries' => 'Legg il Dette Bildet i DIsse galleriene',
'add topic' => 'add topic',
'Add top level bookmarks to menu' => 'Legg il toppnivå bokmerke il menyen',
'add to the set' => '',
...
'Add User' => 'Legg il Bruker',
'Add users' => 'Lägg il användare',
'A direction can be defined by adding either' => 'En retning kan bli deffinert ved å legge il slike',
'adm' => 'adm',
'Admin' => 'Administrera',
...
'Admin. phpBB {$gBitSmarty.session.sid}' => 'Administrer phpBB {$gBitSmarty.session.sid}',
...
'A filter to limit which <strong>Bitweaver</strong> Object will be displayed on the page. The key-words are:' => 'Ett filter for å begrense hvilke <strong>Bitweaver</strong> Objekt som vises på siden. Nøkkelordene er:',
...
'Algeria' => '',
'Alias' => '',
' | ::alignment:: | orientation of the module to the page. Can be  ' => '| ::tekstjustering:: | orienteringen il modulene på siden. Kan være',
...
'All items' => 'All items',
'allow' => 'ilåt',
'Allow access to a listing of all wikipages.' => 'Tillat tilgang il en opplisting over alle wikisider.',
'Allow access to the page\'s history.' => 'Tillat tilgang il sidens historikk.',
'Allow comments' => 'Allow comments',
'Allowed HTML:' => 'HTML ilåtet:',
...
'Allow joining of pages for printing purposes.' => 'Tillat oppsamling av sider il utskrift.',
...
'Allows you to specify a relative or absolute URL the image will link to if clicked. If set to false, no link is inserted.' => 'Tilater deg å spesifisere en relativ eller absolutt URL som bildet lenkes il. Dersom satt il falskt blir ingen lenke lagt inn.',
...
'Allow urls to be imported and saved to the wiki.' => 'Tillat url\'er il å bli importert og lagret il wiki\'en',
'Allow viewing HTML mails' => 'Allow viewing HTML mails',
'Allow viewing HTML mails?' => 'Allow viewing HTML mails?',
'Allow viwing HTML mails?' => 'Tillåt visning av HTML post?',
'Allow watching of comments (who knows if this works).' => 'Tillat overvåkning av komentarer (hvem vet om dette kommer il å virke).',
...
'An entry is posted to a blog' => 'Et innlegg er postet il en blog',
...
'A note for localisations: when you have a language, say \'de\' and you add a localisation such as \'de-at\' it will fist check de-at for a string and then fall back to de. If it still hasn\'t found a translation, it will default to english.' => 'Et notat for lokaliseringer: når du har et språk, for eksempel \'de\' og du legger il en lokalisering som for eksempel \'de-at\' kommer den først il å sjekke i \'de-at\' etter oversettelsestekst om den ikke eksisterer vil den se etter i \'de\'. Har den fremdelses ikke funnet en oversettelse, vil den hente inn verdien fra standard språkpakke (engelsk).',
'answer' => 'svar',
...
'Assign permissions to group' => 'Tilldela rättigheter il grupp',
'Assign permissions to page' => 'Assign permissions to page',
'Assign permissions to this object' => 'Tilldela åtkomsrättigheter il detta objekt',
'Assign permissions to thispage' => 'Tildel rettigheter for denne siden',
'Assign permissions to this page' => 'Tilldela rättigheter il denna sida',
...
'Assign user to groups' => 'Legg il bruker i grupper',
...
'attach' => 'bilägg',
'Attach a file to this item' => 'Billägg en fil il denna post',
'Attachements' => '',
...
'Automagically change words with CamelCaps or under_scores to links to internal wiki pages.' => 'Forvandle ord med KamelBokstavering eller under_strek il å lenke il interne wiki sider.',
'Automatic' => 'Automatic',
'Automatically add users to this group' => 'Automatisk legg il brukere i denne gruppen',
...
'back to the wiki page' => 'tilbake il wiki siden',
'back to top' => 'il toppen',
'back to users' => 'tilbake il brukere',
...
'Banner raw data' => 'Rådata il banners',
'Banners' => 'Banners',
'Banner stats' => '',
...
'Batch user addition' => 'Legg il flerfoldige brukere',
...
' => '',
'both' => 'begge',
'Both of these examples display "The Flash Mind Reader" by Andy Naughton. The first example is on your site and is not very large. The second example is located on the Bitweaver.org site and takes the width of the center column with an appropriat height.' => 'Begge disse eksemplene viser "The Flash Mind Reader" av Andy Naughton. Det første eksemplet finnes på nettstedet Bitweaver.org og tar for seg bredden il senter kolonnen med omtrentlig høyde.',
'Bottom bar' => 'Sidfot',
'box' => 'boks',
...
'break friendship' => '',
'Brief description of the page. This is visible when you hover over a link to this page and just below the title of the wiki page.' => 'En kort beskrivelse av siden. Dette vises når du holder musemarkøren over en lenke il denne siden og rett under tittelen il wikisiden',
...
'Canada' => 'Kanada',
'Can add events in the calendar' => 'Kan legge il hendelser i kallender',
...
'Can attach files to tracker items' => 'Kan legge ved filer il telling',
'Can attach files to wiki pages' => 'Kan legge ved filer il wiki sider',
'Can attach to forum posts' => 'Kan legge ved il fora innlegg',
'Can ban users or ips' => 'Kan avvise brukere eller ip\'er',
'Can broadcast messages to all user' => 'Kan kringkaste meldinger il alle brukerne',
'Can broadcast messages to groups' => 'Kan kringkaste meldinger il gruppene',
...
'canRepeat' => '',
'Can report msgs to moderator' => 'Kan raportere meldinger il moderator',
'Can rollback pages' => 'Kan hente tilbake sider',
'Can save as minor edit' => 'Kan lagre som mindre endring',
'Can send articles to other sites' => 'Kan sende artikkler il andre sider',
'Can send articles to this site' => 'Kan sende artikkler il denne siden',
'Can send instances after completion' => 'Kan sende tilfeller etter fullførelse',
'Can send pages to other sites' => 'Kan sende sider il andre nettsted',
'Can send pages to this site' => 'Kan sende sider il denne siden',
'Can start threads in forums' => 'Kan starte tråder i fora',
'Can submit articles' => 'Kan legge inn artikkler',
'Can submit sites to the directory' => 'Kan legge il nettsted i mappen',
'Can subscribe any email to newsletters' => 'Kan abbonere hvilken som helst epsot il nyhetsbrev',
...
'Can upload pictures to wiki pages' => 'Kan laste opp bilder il wiki sider',
...
' => '',
'Column' => 'Kolumn',
'Column links to edit/view item?' => 'Kolumnlänkar il redigera/visa post?',
...
'Communications (send/receive objects)' => 'Kommunikation (skicka/a emot objekt)',
'Community' => '',
'Community settings' => '',
'Company:' => '',
'compare' => 'sammenlign',
...
'Create or edit a gallery using this form' => 'Legg il eller rediger et galleri',
...
'Creates a listing of Bitweaver objects that have not been categorized.' => 'Opprett en listing av Bitweaver objekt som ennå ikke har blitt kategorisert',
...
'Creating a wiki tag sets sort of \'bookmark\' that can be used to restore the wiki to a specific state.' => 'Opprettelsen av wiki tagger setter et slags \'bokmerke\' som kan brukes il å tilbakeføre wikien il en spesifikk tilstand ',
...
'Creating backups may take a long time. If the process is not completed you will
see a blank screen. If so you need to increment the maximum script execution time
from your php.ini file' => 'Att skapa en säkerhetskopia kan a lång tid. Om kopierandet inte slutförs kommer su att se en baln skärm. Då måste du öka den maximale exekveringstid i din php.ini fil',
'Creating backups may take a long time. If the process is not completed you will
see a blank screen. If so you need to increment the maximum script execution time
from your php.ini file' => '',
...
'Current Layout of \'Home\'' => 'Nåværende utseende il \'Hjem\'',
'Current Layout of \'{if !$fPackage || $fPackage==\'kernel\'}Site Default{else}{$fPackage|capitalize}{/if}\'' => 'Nåværende utseende il \'{if !$fPackage || $fPackage==\'kernel\'}Site Default{else}{$fPackage|capitalize}{/if}\'',
'Current Layout of \'Site Default\'' => 'Nåværende utseende il \'Nettsted Forhåndsvalgt\'',
'Current Node' => '',
...
'Display modules to all groups always' => 'Vis moduler il alle grupper alltid',
...
'editor' => 'redaktör',
'Edit or add category' => 'Redigera eller lägg il kategorin',
'Edit or add poll options' => 'Redigera eller lägg il valmöjligheter',
...
'Feed for Articles' => 'Matning il Artikler',
'Feed for File Galleries' => 'Mating il Filgallerier',
'Feed for forums' => 'Matning il fora',
'Feed for Image Galleries' => 'Matning il Bildgallerier',
'Feed for individual File Galleries' => 'Matning il personliga Filgallerier',
'Feed for individual forums' => 'Matning il personlige fora',
'Feed for individual Image Galleries' => 'Matning il personliga Bildgallerier',
'Feed for individual weblogs' => 'Matning il personliga webloggar',
'Feed for mapfiles' => '',
'Feed for the Wiki' => 'Matning il Wiki',
'Feed for Weblogs' => 'Matning il Weblogss',
'Field' => '',
...
'If you can\'t see the game then you need a flash plugin for your browser' => 'Om du inte kan se spelet, saknar du en flash-plugin il din browser',
...
'Link to user information' => 'Lenk il brukerinformasjon',
'Link type' => 'Länk typ',
'List' => 'Lista',
'List all members' => '',
...
'Most Bitweaver Objects can be selected, including' => 'De fleste Bitweaver Objekt kan velges, inkludert',
...
'Move module to opposite side' => 'Flytt modul il andre siden',
...
'Name of the creator of a page.' => 'Navnet il skaperen av en side',
'Name of the user who\'s avatar should be shown (Default = avatar of user accessing page).' => 'Navnet il brukeren hvis avatar skal bli vist frem (Default = avatar of user accessing page).',
'Name of the wikipage.' => 'Navnet il en wikiside',
...
'No attachments for this item' => 'Inga bilagor il denna post',
'No attachments for this page' => 'Inge bilagda filer tilhör denna sida',
'No backlinks to this page' => 'Ingen referanser il denna siden',
...
'Number of pages that link to a page.' => 'Antall sider som lenker il en side',
...
'Other preferences' => '',
'Other users can upload files to this gallery' => 'Andre användare kan lägga il filer i detta galleri',
'Other users can upload images to this gallery' => 'Andre brukere kan laste opp bilder il dette galleriet',
'Overview' => '',
'Overwrite' => 'Overwrite',
...
'Path to where the dumped files are' => 'Sökvägen il där den avbildade filen finns ',
...
'Permission denied to use this feature' => 'Du har inte rättighet il att använde denna funktion',
...
'Permission denied you cannot remove articles' => 'Du har inte rättighet att a bort denna artikel',
'Permission denied you cannot remove banners' => 'Du har inte rättighet att a bort banners',
'Permission denied you cannot remove files from this gallery' => 'Du har inte rättighet il att slett filer från detta galleri',
'Permission denied you cannot remove images from this gallery' => 'Du har inga rättigheter att a bort bilder från detta galleri',
'Permission denied you cannot remove pages' => 'Permission denied you cannot remove pages',
'Permission denied you cannot remove submissions' => 'Du har inte rättighet att a bort bidrag',
'Permission denied you cannot remove the post' => 'Du har itne rättighet att a bort inlägget',
'Permission denied you cannot remove this blog' => 'Du har inte rättighet att a bort denna blog',
'Permission denied you cannot remove this gallery' => 'Du har inte rättighet att slett detta galleri',
'Permission denied you cannot remove versions from this page' => 'Du har inga rättigheter att a bort versioner från denna sida',
'Permission denied you cannot rollback this page' => 'Du har inte rättighet att ändra tilbaka il tidigare version av denna sida',
...
'Permission denied you cannot view backlinks for this page' => 'Du har inte tilstånd att se refererande länkar il denna sida',
...
'Permission denied you cannot view this section' => 'Du har inte rättighet il att se denna sektion',
...
'Permission denied you cant view this section' => 'Du har inte rättighet il att denna sektion',
'Permission denied you can upload files but not to this file gallery' => 'Du har rättighet att lägga in filer men inte il detta galleri',
...
'Powered by Bitweaver' => 'Drevet av Bitweaver',
...
'reply' => 'besvara',
'replyall' => 'replyall',
'reply all' => 'besvara il alla',
'Reply to parent comment' => '',
'reply to this' => 'svar på detta',
'Reply to this comment' => 'Svar il denne kommentaren',
'reported:' => 'reported:',
...
'Return to block listing' => 'Återvänd il blocklista',
'Return to blog' => 'Återvänd il bloggen',
'return to gallery' => 'tilbake il galleriet',
'Return to home page' => 'Återvänd il hemsida',
'Return to home 
 page' => '',
'Return to home 
                    page' => '',
'Return to HomePage' => 'Återvänd il HjemmeSidan',
'Return to mailbox' => '',
...
'Save this to languages/lang/(lang_code)/language.php where lang_code is the language your are downloading.' => '',
'Save to notepad' => 'Arkiver il notatblokk',
'Scale' => '',
'score' => 'poäng',
...
'Send objects to this site' => 'Skicka objekt il denna sajt',
'Send pages' => '',
'Send post to this addresses' => 'Send post to this addresses',
'Send this forums posts to this email' => 'Skicka inlägg i detta forum il e-post',
...
'There are' => 'Det finns',
'There are inddividual permissions set for this blog' => 'Det finns individuelle tilgångsrättigheter il denna blog',
...
'There are inddividual permissions set for this forum' => 'Det finns individuelle åtkomsträttigheter il detta forum',
...
'to_version' => 'il versjon',
'Trackback pings' => 'Trackback pings',
'Tracker' => 'Tracker',
'Tracker fields' => 'Spårhundsfält',
'Trackeritem' => '',
'Tracker Items' => 'Spårhundsposter',
'Tracker items allow attachments?' => 'Spårhundsposter ilåter bilagor?',
'Tracker items allow comments?' => 'Spårhundsposter ilåter kommentarter?',
'trackers' => 'trackers',
...
'Upload a game' => 'Lägg il ett spel',
'Upload a new game' => 'Lägg il ett nytt spel',
...
'Upload a personal photo to be displayed on your Bitweaver homepage.' => 'Last opp et personligt bilde som blir vist på din Bitweaver hjemmeside',
...
'URL cannot be accessed: wrong URL or site is offline and cannot be added to the directory' => '',
'URL to link the banner' => 'URL som länkar il bannern',
...
'Use cache for external images' => 'Använd cache il externa bilder',
'Use cache for external pages' => 'Använd cache il externa sidor',
...
'Use database to store files' => 'Använd databasen il att lagra filer',
...
'Use (:name:) for smileys' => 'Använd (:namn:) il gladisar',
...
'use square brackets for an' => 'använd hakparenteser il',
...
'Use [URL|description] or [URL] for links' => 'Använd [URL|länktext] eller [URL] il länkar',
...
'Visits to wiki pages' => 'Antall besøk il wiki sider',
'visit the site for more games and fun' => 'besök sajten för att få; tilgång il flere spel och mer underhållning',
'vote' => 'rösta',
...
'Wrong passcode you need to know the passcode to register in this site' => 'Felaktig anmälningskod. Du måste känna il anmälningskoden för att kunna registerar dig på denna hemsida',
...
'You can access the file gallery using the following URL' => 'Du kan få tilgång il detta filgalleri med följande URL',
...
'You can restrict the content listing to a given content type or apply a filter.' => 'Du kan begrense innholdsopplistingen  il en gitt innholdstype eller bruke et filter',
'you can see users rank by score in the module users_rank, for that go to' => '',
'You cant download files' => 'Du har inte rättighet il att hämta filer',
...
'You can use this link to create a random password. Make sure you pass the information on to the user.' => 'Du kan bruke denne lenken il et tilfeldig valgt passord. Sørg for at du videresender informasjonen il brukeren',
...
'You dont have permission to use this feature' => 'Du har inte åtkomst il denna funktion',
