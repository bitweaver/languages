...
"A new article was submitted by {\$mail_user} to {\$mail_site} at {\$mail_date|bit_short_datetime}" => "Um novo artigo foi enviado por \$mail_user} para {\$mail_site} em {\$mail_date|bit_short_datetime}",
...
"New blog post: {\$mail_title} by {\$mail_user} at {\$mail_date|bit_short_datetime}" => "Nova mensagem de blog: {\$mail_title} por {\$mail_user} em {\$mail_date|bit_short_datetime}",
"View the blog at:" => "Veja o blog em:",
"The map {\$mail_page} was changed by {\$mail_user} at {\$mail_date|bit_short_datetime}" => "O mapa {\$mail_page} foi alterado por {\$mail_user} em {\$mail_date|bit_short_datetime}",
...
"The page {\$mail_page} was changed by {\$mail_user} at {\$mail_date|bit_short_datetime}" => "A página {\$mail_page} foi alterada por {\$mail_user} em {\$mail_date|bit_short_datetime}",
"Comment:" => "Comentário:",
"The new page content follows below." => "O conteúdo da nova página está abaixo.",
"The page {\$mail_page} was commented by {\$mail_user} at {\$mail_date|bit_short_datetime}" => "A página {\$mail_page} foi comentada por {\$mail_user} em {\$mail_date|bit_short_datetime}",
"Thank you for you registration. You may log in now." => "Obrigado por registrar-se. Você pode ser logar a partir de agora.",
"The page {\$mail_page} was changed by {\$mail_user} at\n{\$mail_date|bit_short_datetime}" => "A página {\$mail_page} foi alterada por {\$mail_user} em\n{\$mail_date|bit_short_datetime}",
...
"Cc" => "CC",
"'name' parameter for bitmodule missed" => "parâmetro 'nome' para bitmodule está em falta",
