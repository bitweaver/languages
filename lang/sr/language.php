...
"Process does not have exactly one end activity" => "Proces nema ačno jednu krajnju aktivnost",
...
"'name' parameter for bitmodule missed" => "'ime' parametar za bitmodule je promašen",
...
"Cache expiration" => "Isticanje skladiša",
...
"my bitweaver.tpl" => "moj bitweaver.tpl",
...
"The map {\$mail_page} was changed by {\$mail_user} at {\$mail_date|bit_short_datetime}" => "Mapu {\$mail_page} je promenio {\$mail_user} dana {\$mail_date|bit_short_datetime}",
...
"If a theme is assigned to the individual object that theme is used." => "Ako je tema dodeljena individualnom objektu a tema se koristi.",
...
"Select something to vote on" => "Odaberi za ša ćeš da glasaš",
...
"A new article was submitted by {\$mail_user} to {\$mail_site} at {\$mail_date|bit_short_datetime}" => "Nov članak je poslao {\$mail_user} na {\$mail_site} dana {\$mail_date|bit_short_datetime}",
...
"The page {\$mail_page} was changed by {\$mail_user} at {\$mail_date|bit_short_datetime}" => "Strana {\$mail_page} je promenjena od strane korisnika {\$mail_user} dana {\$mail_date|bit_short_datetime}",
