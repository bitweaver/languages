...
'Activity=' => 'Aktivit&auml;t=',
'Activity: 0' => 'Aktivit&auml;t: 0',
'Activity: 2.00' => 'Aktivit&auml;t: 2.00',
'Activity: 4.00' => 'Aktivit&auml;t: 4.00',
'Activity: 7.25' => 'Aktivit&auml;t: 7.25',
'Activity completed' => 'Aktivit&auml;t erfolgreich beendet',
'Activity (desc)' => 'Aktivit&auml;t (abst.)',
'Activity: {$listpages[changes].activity|default:0}' => 'Aktivit&auml;t: {$listpages[changes].activity|default:0}',
...
'Advanced Search' => '',
'A filter to limit which <strong>TikiPro</strong> Object will be displayed on the page. The key-words are:' => 'Filter, um einzugrenzen welches <strong>TikiPro</strong> Objekt auf der Seite angezeigt wird. Die Schlüsselwörter sind:',
...
'Attachment Browser' => 'Anh&auml;nge w&auml;hlen',
...
' => '',
'both' => 'beides',
'Both of these examples display "The Flash Mind Reader" by Andy Naughton. The first example is on your site and is not very large. The second example is located on the TikiPro.org site and takes the width of the center column with an appropriat height.' => 'Diese beiden Beispiele zeigen "The Flash Mind Reader" von Andy Naughton. Das erste Beispiel ist auf Ihrer Seite und nicht sehr groß. Das zweite Beispiel befindet sich auf tikipro.org und ist so breit wie die mittlere Spalte mit einer passenden Höhe.',
...
'Creates a listing of TikiPro objects that have not been categorized.' => 'Erstellt eine Liste der TikiPro Objekte, die noch nicht kategorisiert wurden.',
...
'Create watch for author on page creation' => 'Beobachtungspunkt f&uuml;r Autor bei Seitenerstellung',
'Create WebHelp' => '',
...
'Edit TikiPro' => 'TikiPro editieren',
...
'Fatal error: cannot execute automatic activity $activity_id' => 'Fataler Fehler: Kann automatische Aktivit&auml; $activity_id nicht ausf&uuml;hren',
...
'for' => 'f&uuml;r',
'For additional information about this plugin - see TikiPro.Org or click <a class=\'wiki\' target=_blank href=\'{$p.tpopg}\'><strong>Here</strong></a> to visit.' => 'Für weiterführende Informationen über dieses Plugin siehe TikiPro.Org oder klicken Sie <a class=\'wiki\' target=_blank href=\'{$p.tpopg}\'><strong>hier</strong></a>.',
...
'for numbered lists' => 'f&uuml;r nummerierte Listen',
...
'Most TikiPro Objects can be selected, including' => 'Die meisten TikiPro Objekte können gewählt werden, einschließlich',
...
'Send me an email for messages with priority equal or greater than' => 'Schicke mir eine E-Mail beim Eintreffen von Nachrichten mit Priorit&auml;t gr&ouml;&szlig;er gleich',
...
'Show last_modified date when listing tracker items?' => '&Auml;nderungsdatum beim Auflisten von Tracker-Eintr&auml;gen anzeigen?',
...
'Sites using TikiPro' => 'Sites, die TikiPro benutzen',
'Site Theme' => '',
...
'The SandBox is a page where you can practice your editing skills, use the preview feature
to preview the appeareance of the page, no versions are stored for this page.' => '',
'The Sandbox is a wikipage that can be modified by any user to practise the wiki syntax. This page has no history nor is the contents searchable.' => 'Die SandBox ist eine Seite, an der Sie Ihre Editierf&auml;higkeiten &uuml;ben k&ouml;nnen. Benutzen Sie das Vorschau-Feature, um sich das Resultat Ihrer Seite anzusehen. Keine Version dieser Seite wird gespeichert.',
...
'The text in RED is' => '',
'The text is' => '',
'The Themes package is an integral part of TikiPro which allows you to control the look and feel of you site.' => 'Das Themes Paket ist integraler Bestandteil von TikiPro. Es erlaubt Ihnen, Look & Feel Ihrer Site zu kontrollieren.',
...
'This plugin automatically creates a link to the appropriate ))SourceForge(( object for ))TikiPro((.' => 'Dieses Plugin erstellt automatisch einen Link zum ))SourceForge(( Eintrag ))TikiPro((.',
...
'This will display translation strings for all TikiPro versions.' => 'Dies zeigt Zeichenketten zur Übersetzung für alle TikiPro Versionen an. ',
'This will display translation strings for all TikiPro versions. This means it will also show strings that are not used at all and might be useless to you.' => 'Dies zeigt Zeichenketten zur Übersetzung für alle TikiPro Versionen an. Das heißt, es werden auch Zeichenketten angezeigt, die gar nicht benutzt werden, und die möglicherweise für Sie uninteressant sind.',
...
'This will export translation strings for the all TikiPro versions.' => 'Dies exportiert Zeichenketten zur Übersetzung für alle TikiPro Versionen an. ',
...
'TikiPro is hosted by SourceForge' => 'TikiPro wird von SourceForge gehostet.',
'Tiki Projects' => '',
...
'To include any content from tikipro insert the apprpropriate numeric content id. This can include blog posts, images, wiki texts...<br />
					Avaliable content can be viewed <a href="/liberty/list_content.php">here</a>' => 'Um Inhalt von TikiPro zu verwenden, fügen Sie die passende nummerische Content ID ein. Dazu gehören Blog Postings, Bilder, Wiki Texte und andere <a href="/liberty/list_content.php">mögliche Inhalte</a>',
...
'Track which strings are used in this version of TikiPro so only the currently used strings appear while editing translations. You MUST <a href="/languages/edit_languages.php">clear your language and templates cache</a> after enabling this option.' => 'Überwache, welche Zeichenketten in dieser Version von TikiPro benutzt werden, damit nur die tatsächlich vorhandenen zur Übersetzung erscheinen. Sie MÜSSEN <a href="/languages/edit_languages.php">den Sprachen und Templates Zwischenspeicher leeren</a> nach der Aktivierung dieser Option.',
'Traditional Chinese' => '',
'Transcript' => 'Logbuch',
