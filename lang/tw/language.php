...
"A new article was submitted by {\$mail_user} to {\$mail_site} at {\$mail_date|bit_short_datetime}" => "{\$mail_user} 傳送新文章至 {\$mail_site} 於 {\$mail_date|bit_short_datetime}",
...
"New blog post: {\$mail_title} by {\$mail_user} at {\$mail_date|bit_short_datetime}" => "新 blog 佈告: {\$mail_title} 由 {\$mail_user} 發表於 {\$mail_date|bit_short_datetime}",
"View the blog at:" => "檢視此 blog 於:",
"If you don't want to receive these notifications follow this link:" => "如果你不想再收到這些通知請使用此連結:",
"The page {\$mail_page} was changed by {\$mail_user} at {\$mail_date|bit_short_datetime}" => "此頁面 {\$mail_page} 由 {\$mail_user} 更改於 {\$mail_date|bit_short_datetime}",
