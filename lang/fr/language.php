...
'A filter to limit which <strong>Bitweaver</strong> Object will be displayed on the page. The key-words are:' => 'Un filtre pour limiter quel <strong>Bitweaver</strong> Objet sera affiché sur la paage. Mes Mots-clés sont:',
...
' => '',
'both' => 'les deux',
'Both of these examples display "The Flash Mind Reader" by Andy Naughton. The first example is on your site and is not very large. The second example is located on the Bitweaver.org site and takes the width of the center column with an appropriat height.' => 'Ces deux exemples affichent "The Flash Mind Reader" par Andy Naughton. Le premier exemple est sur votre site et n\'est pas très grand. Le second est situé sur le site Bitweaver.org et occupe la largeur de la colonne centrale avec une hauteur appropriée.',
...
'Creates a listing of Bitweaver objects that have not been categorized.' => 'Crée une liste des objets Bitweaver qui n\'ont pas encore été classé dans une catégorie',
...
href="http://www.bitweaver.org/wiki/index.php?page=WikiSyntax">WikiSyntax</a> sur <a href="http://www.tikiwiki.org">TikiWiki.org</a>.',
'For more information, please see <a
href="http://www.bitweaver.org/wiki/index.php?page=WikiSyntax">WikiSyntax</a>
