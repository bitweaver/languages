...
"From" => "De",
"'name' parameter for bitmodule missed" => "le paramètre 'name' manque à bitmodule",
...
"A new article was submitted by {\$mail_user} to {\$mail_site} at {\$mail_date|bit_short_datetime}" => "Un nouvel article a été publié par {\$mail_user} sur {\$mail_site} à {\$mail_date|bit_short_datetime}",
